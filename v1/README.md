...
- Genetic Algorithm implementation inspired by Samuel Arzt (March 2017)
[https://arztsamuel.github.io/en/projects/unity/deepCars/deepCars.html](https://arztsamuel.github.io/en/projects/unity/deepCars/deepCars.html)
- Urho3D: [https://urho3d.io/](https://urho3d.io/)
- Built using the Urho3D engine, special thanks to it's group of developers.
- Especially Lumak for vehicle raycasting demos: [https://github.com/Lumak] (https://github.com/Lumak)
