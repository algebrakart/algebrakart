...
#include <TrafficCity/network/csp/CSP_Client.h>
#include <TrafficCity/network/csp/CSP_Server.h>
#include <TrafficCity/network/csp/CSP_messages.h>
#include "Game.h"
...
#define APP_VERSION "TrafficCity v1.0c"
#define STUDIO_VERSION "Monkey Maya Studios"
#define GAME_NAME "TrafficCity"
...
*/
class TrafficCity : public Game
{
    URHO3D_OBJECT(TrafficCity, Game);
public:
    /// Construct.
    explicit TrafficCity(Context* context);
